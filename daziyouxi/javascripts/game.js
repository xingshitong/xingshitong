   ...
   play:function(){
    ...
    getLetter:function(num){
        ...
        for(var i=0;i<arr.length;i++){
            ...
            span.style.cssText="width:50px;position:absolute;left:"+x+"px;top:"+y+"px;color:#fff;font-size:24px;background:url(img/huoqiu.png) no-repeat;line-height:70px;text-align:center;";
            document.body.appendChild(span);
           // eleArr.push(span);
            this.spans.push(span);
            this.currArr.push(span);
        }
       // return eleArr;
